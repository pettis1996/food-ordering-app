    ...
    return (
        <section className="mt-8">
            ...
            <form className="block max-w-xs mx-auto" onSubmit={handleFormSubmit}>
                <input required disabled={false} type="email" placeholder="email" value={email} onChange={ev => setEmail(ev.target.value)} />
                <input required disabled={false} type="password" placeholder="password" value={password} onChange={ev => setPassword(ev.target.value)} />
